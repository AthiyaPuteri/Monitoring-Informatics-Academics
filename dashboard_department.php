...
<body class="flex w-screen h-screen space-x-6 bg-gray-300">
  ...
  <div class="content-right p-8">
    ...
    <div class="info-mhs mt-5">
      <div class="profile-photo">
        <i class="bi bi-person-circle"></i>
      </div>
      <div class="profile-info">
        <h1 class="type">Departemen</h1>
        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Debitis laboriosam accusamus animi unde facilis at
          excepturi, perferendis rem ab similique.</p>
      </div>
    </div>
  </div>
