...
<body class="flex w-screen h-screen space-x-6 bg-gray-300">
    ...
    <div class="w-full px-2">
      <div class="flex flex-col items-center w-full mt-3 border-t border-gray-700">
        ...
        <a class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300"
          href="./data_perwalian.php">
          <svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
          </svg>
          <span class="ml-2 text-sm font-medium">Data Perwalian</span>
        </a>
  ...
  <div class="content-right p-8">
    <div class="title">
      <h1>Selamat Datang, Verrel!</h1>
    </div>
    <div class="search-mhs mt-5">
    ...
    <div class="grid-container mt-10">
      <div class="grid-item item1">
        ...
        <div class="profile-info">
          <h1 class="type">Dosen</h1>
          <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Debitis laboriosam accusamus animi unde facilis
            at excepturi, perferendis rem ab similique.</p>
        </div>
      </div>
      <div class="grid-item item2 d-flex flex-column">
        <h2 style="font-size: 20px;">Mahasiswa Perwalian</h2>
        <h2 style="font-size: 50px;">65</h2>
      </div>
      <div class="grid-item item3">
        <h2 style="font-size: 20px;">Mahasiswa Perwalian Status Aktif</h2>
        <h2 style="font-size: 50px;">57</h2>
      </div>
    </div>
  </div>
