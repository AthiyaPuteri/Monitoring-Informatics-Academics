...
<body class="flex w-screen h-screen space-x-6 bg-gray-300">
  <div class="flex flex-col items-center w-40 h-full overflow-hidden text-gray-400 bg-gray-900 rounded">
    ...
    <div class="w-full px-2">
      <div class="flex flex-col items-center w-full mt-3 border-t border-gray-700">
        ...
        <a class="flex items-center w-full h-12 px-3 mt-2 bg-gray-700 rounded" href="./data_perwalian.php">
          <svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
  ...
  <div class="content-right p-8">
    <div class="title">
      <h1>Data Perwalian Mahasiswa</h1>
    </div>
    <div class="table-mhs mt-5 mx-auto">
      <table class="table table-bordered">
        ...
        <tbody>
          <tr>
            ...
            <td>Otto</td>
            <td>2020</td>
            <td class="text-center"><button class="btn btn-info rounded-pill" style="font-size: 12px;">Detail</button>
            </td>
          </tr>
          <tr>
            <th scope="row">2</th>
